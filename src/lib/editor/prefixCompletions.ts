...
const commonTerms: Record<string, string[]> = {
  rdf: ['type', 'Property', 'Statement', 'subject', 'predicate', 'object', 'List', 'nil', 'first', 'rest'],
  rdfs: ['label', 'comment', 'subClassOf', 'subPropertyOf', 'domain', 'range', 'Class', 'Resource', 'Literal', 'Datatype', 'seeAlso', 'isDefinedBy'],
  owl: ['Class', 'ObjectProperty', 'DatatypeProperty', 'Thing', 'sameAs', 'inverseOf', 'TransitiveProperty', 'SymmetricProperty', 'FunctionalProperty', 'InverseFunctionalProperty'],
  xsd: ['string', 'integer', 'decimal', 'boolean', 'date', 'dateTime', 'float', 'double', 'long', 'int', 'short', 'byte', 'nonNegativeInteger', 'positiveInteger', 'anyURI'],
  foaf: ['name', 'Person', 'knows', 'homepage', 'mbox', 'depiction', 'Organization', 'Agent', 'Document', 'Image', 'givenName', 'familyName', 'nick', 'title'],
  skos: ['Concept', 'prefLabel', 'altLabel', 'broader', 'narrower', 'related', 'ConceptScheme', 'notation', 'note', 'definition', 'example', 'hiddenLabel'],
  ...
  dcterms: ['title', 'creator', 'subject', 'description', 'publisher', 'contributor', 'date', 'type', 'format', 'identifier', 'source', 'language', 'relation', 'coverage', 'rights', 'license', 'created', 'modified'],
  schema: ['name', 'description', 'url', 'image', 'Person', 'Organization', 'Thing', 'Product', 'Event', 'Place', 'CreativeWork', 'author', 'datePublished'],
  dbo: ['abstract', 'birthDate', 'deathDate', 'Person', 'Place', 'Organization', 'Work', 'Species', 'wikiPageID', 'thumbnail'],
